...
// make_sandwich("chicken", "bread", "mustard");


// answer no 45

// function create_car(manufacturer: string, model: string, ...options: { [key: string]: any }[]): { manufacturer: string, model: string, options: { [key: string]: any } } {
//     let car: { manufacturer: string, model: string, options: { [key: string]: any } } =
//     {manufacturer: manufacturer,model: model,options: {}};
//  for (let option of options)
//        {let key = Object.keys(option)[0]; car.options[key] = option[key];} return car;}
